...
\begin{itemize}
\item 8 MX+ [OUR CAMERA MODEL, PROBABLY 3] Megapixels cameras, fitted with sensitive solid-state
...
the Vicon software installed on this host PC (in our case Vicon IQ 2.5) and MX Ultranet.
No other special requirements for Host PC, but processor and memory are vital for being able to achieve better results.
\end{itemize}

\begin{figure}[H]
  \centering
  \includegraphics[width=93mm]{images/vicon_mx_basic.jpg}
\end{figure}
