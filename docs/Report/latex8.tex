...
\begin{center}
(a + i*b + j*c + k*d) * (e + i*f + j*g + k*h) = a * e + i * a*f  + j * a*g + k * a*h + i *b*e - b*f  + k * b*g - j * b*h + j *e*c - k * c*f - c*g + i * c*h + k * e*d + j * d*f - i * d*g - d*h =
...
\begin{itemize}
\item a = $cos(angle / 2)$
\item b =  $axis_x * sin(angle / 2)$
\item c = $axis_y * sin(angle / 2)$
\item d = $axis_z * sin(angle / 2)$
\end{itemize}
