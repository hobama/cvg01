...
\begin{figure}[H]
  ...
  \label{our_skeleton}
  \centering
  \includegraphics[width=85mm]{images/our_skeleton.jpg}
\end{figure}
...
\begin{figure}[H]
  ...
  \centering
  \includegraphics[width=85mm]{images/mesh_connection.jpg}
\end{figure}

Any line function can be written as: \emph{L(t) = A + b*t}, where \emph{A} is the starting point of a line, \emph{b} is a vector, determining the direction of a line and \emph{t} is a parameter value. A more detailed explanation of the parametric representation of the line can be found in documents section \ref{line_in_space}.
...
\begin{figure}[H]
  ...
  \label{knee_3axis}
  \centering
  \includegraphics[width=85mm]{images/s_knee.jpg}
\end{figure}
...
\begin{figure}[H]
  ...
  \label{knee_1axis}
  \centering
  \includegraphics[width=85mm]{images/s_knee_rot1.jpg}
\end{figure}
