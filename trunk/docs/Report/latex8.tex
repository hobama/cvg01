...
The whole system must be well calibrated and set up and after capturing,
data needs to be cleaned, edited, and applied to a 3D model.

%-------------------------------------------------------------------------
\SubSection{Vicon MX motion capture system}

In this project we'll be using Vicon MX 8 cameras motion capture system,
to capture motion data of human movements and then apply them to our model.
